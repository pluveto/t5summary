...
def train_model(model, adam, train_data, dev_data, tokenizer, device, args):
    ...
    for epoch in range(args.num_epoch):
        ...
        for i, cur in enumerate(
                tqdm(train_data, desc='Epoch {}:'.format(epoch))):
...
def init_argument():
    ...
    parser.add_argument(
        '--train_data',
        default='/content/drive/MyDrive/data/t5abstract/dat/sample_data.tsv')
    parser.add_argument(
        '--dev_data',
        default='/content/drive/MyDrive/data/t5abstract/dat/sample_data_dev.tsv'
    )
    parser.add_argument(
        '--pretrain_model',
        default='/content/drive/MyDrive/data/t5abstract/chinese_t5_pegasus_base'
    )
    ...
    parser.add_argument('--max_len_generate',
                        default=40,
...
if __name__ == '__main__':
    ...
    tokenizer = T5TokenizerFast.from_pretrained(args.pretrain_model)
    train_data = prepare_data(device,
                              tokenizer=tokenizer,
